...
-- Date        : Mon May 16 22:10:46 2022
-- Host        : MS-QMGTGLWCUXSR running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               e:/ZYNQ_demo/test/SD2HDMI/SD2HDMI/SD2HDMI.srcs/sources_1/bd/system/ip/system_v_axi4s_vid_out_0_0/system_v_axi4s_vid_out_0_0_sim_netlist.vhdl
...
entity system_v_axi4s_vid_out_0_0_xpm_memory_base is
  ...
  attribute MEMORY_SIZE of system_v_axi4s_vid_out_0_0_xpm_memory_base : entity is 19456;
...
entity system_v_axi4s_vid_out_0_0_xpm_fifo_base is
  ...
  attribute FIFO_SIZE of system_v_axi4s_vid_out_0_0_xpm_fifo_base : entity is 19456;
...
entity system_v_axi4s_vid_out_0_0_xpm_fifo_sync is
  ...
  attribute READ_DATA_WIDTH : integer;
  attribute READ_DATA_WIDTH of system_v_axi4s_vid_out_0_0_xpm_fifo_sync : entity is 19;
  ...
  attribute WRITE_DATA_WIDTH : integer;
  attribute WRITE_DATA_WIDTH of system_v_axi4s_vid_out_0_0_xpm_fifo_sync : entity is 19;
  attribute WR_DATA_COUNT_WIDTH : integer;
...
COUPLER_INST: entity work.system_v_axi4s_vid_out_0_0_v_axi4s_vid_out_v4_0_10_coupler
     port map (
      ...
      \grdc.rd_data_count_i_reg[6]\ => COUPLER_INST_n_35,
      overflow => overflow,
      s_axis_video_tready => s_axis_video_tready,
      s_axis_video_tvalid => s_axis_video_tvalid,
      underflow => underflow
...
SYNC_INST: entity work.system_v_axi4s_vid_out_0_0_v_axi4s_vid_out_v4_0_10_sync
     port map (
      ...
      \FSM_sequential_state_reg[2]_0\ => COUPLER_INST_n_35,
      SR(0) => vid_reset,
      aclk => aclk,
      aresetn => aresetn,
      dout(2) => fifo_fid,
...
architecture STRUCTURE of system_v_axi4s_vid_out_0_0 is
  ...
  attribute X_INTERFACE_PARAMETER of aclk : signal is "XIL_INTERFACENAME aclk_intf, ASSOCIATED_BUSIF video_in, FREQ_HZ 148500000, PHASE 0.0, CLK_DOMAIN /clk_wiz_clk_out1, INSERT_VIP 0";
  ...
  attribute X_INTERFACE_PARAMETER of s_axis_video_tlast : signal is "XIL_INTERFACENAME video_in, TDATA_NUM_BYTES 2, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 1, HAS_TREADY 1, HAS_TSTRB 0, HAS_TKEEP 0, HAS_TLAST 1, FREQ_HZ 148500000, PHASE 0.0, CLK_DOMAIN /clk_wiz_clk_out1, LAYERED_METADATA undef, INSERT_VIP 0";
